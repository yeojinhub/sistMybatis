...
<h3>입력된 연봉보다 높은 연봉을 수령하는 사원정보를 검색</h3>
...
pageContext.setAttribute("empList", ss.greaterThan(Integer.parseInt(paramSal)));
	
}//if

%>

	<h2><c:out value="${param.sal }"/>보다 높은 연봉을 수령하는 사원 정보</h2>
		...
		<tr>
		<td colspan="7">입력하신 연봉보다 많이 받는 사원은 없어요. ㅇㅅㅇ!</td>
		</tr>
		</c:if>
